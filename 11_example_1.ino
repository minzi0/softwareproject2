...
// Target Distance
#define _TARGET_LOW  180.0  // 18cm in mm
#define _TARGET_HIGH 360.0  // 36cm in mm
...
void loop() {
  ...
  if (dist_ema <= _TARGET_LOW) {
    ...
    servo_angle = map(dist_ema, _TARGET_LOW, _TARGET_HIGH, 0, 180); // map distance to servo angle
  }
